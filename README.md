...
OUTPUT:
[text](<../../../../../Documents/math r/exp5 prompt.pdf>)
RESULT: 
The experiment demonstrated that ChatGPT consistently provides better results when given basic, structured prompts. Clear instructions, context, and specific requirements improve the quality, accuracy, and depth of generated responses. While naïve prompts can produce acceptable answers for simple tasks, basic prompts are more effective for obtaining detailed, relevant, and reliable outputs. Therefore, well-structured prompts are recommended for achieving optimal performance from ChatGPT.
